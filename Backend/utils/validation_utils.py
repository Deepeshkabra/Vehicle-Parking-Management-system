...
def validate_reservation_time_slot(parking_timestamp: datetime, leaving_timestamp: Optional[datetime] = None) -> bool:
...
def validate_spot_number_uniqueness(lot_id: int, spot_number: int, existing_spots: List[Dict]) -> bool:
...
def validate_pagination_params(page: int, per_page: int, max_per_page: int = 100) -> bool:
