...
def handle_unauthorized_exception(error: UnauthorizedException):
    ...
    response = {"error": "Unauthorized", "message": error.message}
...
def handle_forbidden_exception(error: ForbiddenException):
    ...
    response = {"error": "Forbidden", "message": error.message}
...
def handle_integrity_error(error: IntegrityError):
    ...
    response = {"error": "Database error", "message": message}
...
def handle_http_exception(error: HTTPException):
    ...
    response = {"error": error.name, "message": error.description, "code": error.code}
...
def validate_request_data(schema_class, data: Dict[str, Any]):
    ...
    try:
        ...
        raise ValidationException(
            "Request validation failed", format_validation_errors(e)
        )
