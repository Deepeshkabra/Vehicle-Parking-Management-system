...
class ParkingLotBase(BaseSchema):
    ...
    prime_location_name: str = Field(..., min_length=3, max_length=100, description="Location name")
    address: str = Field(..., min_length=10, description="Full address")
    pin_code: str = Field(..., description="PIN code")
    number_of_spots: int = Field(..., ge=1, le=1000, description="Number of parking spots")
