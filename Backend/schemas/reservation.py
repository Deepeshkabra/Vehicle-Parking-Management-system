...
class ReservationBase(BaseSchema):
    ...
    expected_leaving_time: Optional[datetime] = Field(
        None, description="Expected departure time"
    )
    vehicle_number: Optional[str] = Field(
        None, max_length=20, description="Vehicle license plate"
    )
    vehicle_model: Optional[str] = Field(
        None, max_length=50, description="Vehicle model"
    )
    vehicle_color: Optional[str] = Field(
        None, max_length=20, description="Vehicle color"
    )
...
class ReservationComplete(BaseSchema):
    ...
    leaving_timestamp: Optional[datetime] = Field(
        None, description="Actual leaving time"
    )
    remarks: Optional[str] = Field(
        None, max_length=500, description="Completion remarks"
    )
