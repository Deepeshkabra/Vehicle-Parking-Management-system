...
class ParkingSpot(db.Model):
    ...
    lot_id = db.Column(
        db.Integer, db.ForeignKey("parking_lots.id"), nullable=False, index=True
    )
    ...
    reservations = db.relationship(
        "Reservation", backref="parking_spot", lazy=True, cascade="all, delete-orphan"
    )
    ...
    def to_dict(self):
        ...
        return {
            ...
            "current_reservation": (
                current_reservation.to_dict() if current_reservation else None
            ),
